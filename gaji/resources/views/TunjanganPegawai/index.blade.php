...
<div class="container">
        ...
        <div class="col-md-12">
            <div class="panel panel-black">
                ...
                <div class="panel-body">
                    <center><a href="{{route('tunpeg.create')}}" class="btn btn-success">Tambah Data</a></center>
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<td><center><a href="{{route('tunpeg.edit', $data->id)}}" class="btn btn-primary">Edit</a></center></td>
			<td><center>
